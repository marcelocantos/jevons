...
export const CATALOG: readonly OracleFamily[] = [
  ...
  {
    id: 'composer-keys',
    title: 'Composer chords — Tab, Home/End, Alt+Enter, Cmd+Enter, queue',
    file: 'composer-keys.test.ts',
    layer: 'hermetic',
    covers: covers('composer-keys', ['T113', 'T126', 'T127', 'T132', 'T149', 'T153', 'T235', 'T241', 'T307', 'T366', 'T540.3.1', 'T547', 'T549', 'T571', 'T644']),
  },
  {
    id: 'composer-chrome',
  ...
  },
  {
    ...
    layer: 'hermetic',
    covers: covers('frontier', ['T131', 'T168', 'T173', 'T175', 'T179', 'T181', 'T184', 'T186', 'T187', 'T189', 'T203', 'T230', 'T231', 'T248', 'T271', 'T280', 'T294', 'T326', 'T340', 'T485', 'T643', 'T647', 'T648']),
  },
  {
    id: 'journey-connect',
  ...
  },
  {
    ...
    layer: 'journey',
    covers: covers('journey-frontier', ['T168', 'T173', 'T175', 'T181', 'T184', 'T186', 'T230', 'T643'], ['frontier']),
  },
  {
    id: 'journey-ticker',

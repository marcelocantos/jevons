...
| T194 / T552 daily-path | persona/AGENTS/agents-guide/fleet_brief: owner-visible claims are observed (T552); hermetics alone are not enough; `HasDailyPathEvidence` is a seam classifier, not an achieve gate. T553.2 workers do not auto-bounce. Pure classifier tests live in `internal/mcpserver`. Not a live daily bounce. |

// Copyright 2024 Damian Tarnawski — streaming-markdown 0.2.15 (MIT)
// https://github.com/thetarnav/streaming-markdown
// Vendored for jevons 🎯T150 (UMD wrapper; source is ESM).
// Do not edit by hand — regenerate from npm package streaming-markdown@0.2.15.
...
return {
  ...
  attr_to_html_attr: attr_to_html_attr,
  parser: parser,
  parser_write: parser_write,
  parser_end: parser_end,
  default_renderer: default_renderer,
  default_add_token: default_add_token,
  default_end_token: default_end_token,
  default_add_text: default_add_text,
  default_set_attr: default_set_attr,
  logger_renderer: logger_renderer,
  logger_add_token: logger_add_token,
  logger_end_token: logger_end_token,
  logger_add_text: logger_add_text,
  logger_set_attr: logger_set_attr,
  level_to_heading: level_to_heading,
  heading_from_level: heading_from_level,
  heading_to_level: heading_to_level,
};
}));

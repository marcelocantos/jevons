...
(function (root, factory) {
  ...
  //   cursor — Cursor, from Simple Icons (CC0-1.0), verbatim path data:
  //     https://github.com/simple-icons/simple-icons/blob/develop/icons/cursor.svg
  //     viewBox 0 0 24 24.
  //
